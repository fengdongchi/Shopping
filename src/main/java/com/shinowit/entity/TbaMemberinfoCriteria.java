...
public class TbaMemberinfoCriteria {
    ...
    public TbaMemberinfoCriteria(int pageSize, int pageIndex) {
        this();
        this.pageSize=pageSize;
        this.pageIndex=pageIndex;
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andActivedateLikeInsensitive(String value) {
            addCriterion("upper(ActiveDate) like", value.toUpperCase(), "activedate");
            return (Criteria) this;
        }
