...
<%
     session.getAttribute("merchaninfo");
%>
<html>
<head>
...
<div class="nav">
    <ul>
        ...
        <li><a href="#">蜜饯果脯</a></li>
        <li class="last">
            <div id="welcome" class="welmsgdiv2"><span>您好，欢迎光临果果香。</span><a href="<%=request.getContextPath()%>/loging/login">登录</a><span class="Lloginfg">&nbsp;</span><a href="<%=request.getContextPath()%>/views/reg1">注册</a></div>
        </li>
    </ul>
</div>
<!--header end -->
...
<div id="body" style="margin-top:1px;">
    ...
    <div id="mid">
        ...
        <div class="pro_price">
            <dl>
                <dt><img src="<%=request.getContextPath()%>/${merchaninfo.picpath}" width="310" height="310" /></dt>
                <dd><table height="413" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border:#ccc 1px solid;">
                    ...
                    <tr>
                        <td valign="top" align="middle" width="323" colspan="2"
                            height="30"><font
                                color="#bb1213"><strong>${merchaninfo.merchandisename}</strong></font></td>
                    </tr>
                    <tr>
                        <td valign="top" align="right" width="111"
                            height="28">市 场 价：</td>
                        <td valign="top" width="212" height="28"><span style="text-decoration:line-through; font-size:14px;color:#666; font-weight:bold;">￥${merchaninfo.price}</span></td>
                    </tr>

                    <tr>
                        <td valign="top" align="right" width="111"
                            height="28">规&nbsp;&nbsp;&nbsp; 格：</td>
                        <td valign="top" width="212" height="28">${merchaninfo.spec}</td>
                    </tr>
                    <tr>
