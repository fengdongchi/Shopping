...
<div id="box">
    <!--top start -->
    <div id="top">
        <a href="<%=request.getContextPath()%>/index.jsp"><img src="images/logo.gif" alt="Estimation" width="255" height="58" border="0" class="logo" /></a>
        <p class="topDiv"></p>
        <p class="navLeft"></p>
        <ul>
        ...
        <div id="Login">
            <DIV id="gwc">
                ...
                <table class="tabSty01" border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td height="50" class="typeTd2"><a href="<%=request.getContextPath()%>/chart04.jsp"><img src="<%=request.getContextPath()%>/images/button_000.gif" border="0" onclick="#" /></a><br />
                        </td>
                </table>
<SPAN
