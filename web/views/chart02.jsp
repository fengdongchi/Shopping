...
<div id="box">
    <!--top start -->
    <div id="top">
        <a href="<%=request.getContextPath()%>/index.jsp"><img src="<%=request.getContextPath()%>/images/logo.gif" alt="Estimation" width="255" height="58" border="0" class="logo" /></a>
        <p class="topDiv"></p>
        <p class="navLeft"></p>
        <ul>
    ...
    <div class="nav">
        <ul>
            ...
            <li><a href="#">蜜饯果脯</a></li>
            <li class="last">
                <div id="welcome" class="welmsgdiv2"><span>您好，欢迎光临果果香。</span><a href="<%=request.getContextPath()%>/login.jsp">登录</a><span class="Lloginfg">&nbsp;</span><a href="<%=request.getContextPath()%>/views/reg">注册</a></div>
            </li>
        </ul>
    </div>
    <!--header end -->
    ...
    <div id="body">
        ...
        <h4 align="left"><span class="reusableColor3 letterSpac">收货人</span><span class="reusableColor3 letterSpac1">：</span>刘德华<br />
            ...
            <span class="reusableColor3">联系方式：</span>138********</h4>
                    ...
                    <tr>
                        <td class="typeTd2"><span class="addDeleteSty addFontCol"><a href="#"><span class="addFontCol">修改</span></a><span class="addFontCol">　|</span>　<a href="#"><span class="addFontCol">删除</span></a></span><span class="addSpanSty"><a href="${ctx}chart03.jsp"><img src="<%=request.getContextPath()%>/images/button_qr.gif" border="0" onclick="#" /></a></span><br />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
